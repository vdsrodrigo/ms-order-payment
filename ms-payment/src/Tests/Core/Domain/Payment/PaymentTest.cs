...
{
    public static Guid FixedID = new Guid("6cf2b9ea-d3d9-4225-9170-00f73788ffb5");
    public static Guid OrderIDFixedID = new Guid("4a91f83c-633f-4ff1-8fd0-30deff01bbb7");
